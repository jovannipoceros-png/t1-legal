      ...
      <div style={{ width: '100%', maxWidth: '420px', padding: '32px' }}>
        ...
        <div style={{ background: 'rgba(255,255,255,0.08)', borderRadius: '16px', padding: '32px', border: '1px solid rgba(255,255,255,0.1)' }}>
          <div style={{ marginBottom: '20px' }}>
            <label style={{ display: 'block', color: '#B0C4DE', fontSize: '13px', fontWeight: 600, marginBottom: '8px' }}>Correo electronico</label>
            <input type="email" placeholder="tu@empresa.com" style={{ width: '100%', padding: '12px 16px', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.2)', background: 'rgba(255,255,255,0.08)', color: 'white', fontSize: '14px', boxSizing: 'border-box' }} />
          </div>
          ...
          <div style={{ textAlign: 'center' }}>
            <a href="/solicitar" style={{ color: '#B0C4DE', fontSize: '13px', textDecoration: 'none' }}>Primera vez? Haz una solicitud aqui</a>
          </div>
        </div>
      </div>
    </div>
